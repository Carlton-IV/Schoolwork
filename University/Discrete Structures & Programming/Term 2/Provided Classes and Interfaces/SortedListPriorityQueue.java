...
public boolean isEmpty() {return entries.isEmpty();}
 /** Returns but does not remove an entry with minimum key. */
  ...
  public static void main(String[] args) {
	  ...
	  SortedListPriorityQueue <Integer, Integer> SPQC =
	  	  new SortedListPriorityQueue <Integer, Integer>(new integerComparator());
	  ...
	  SortedListPriorityQueue <Integer, Integer> SPQCB =
	  	  	  new SortedListPriorityQueue <Integer, Integer>(new BinaryTest());
