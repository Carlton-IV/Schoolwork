...
public class LinkedBinaryTree<E> implements BinaryTree<E> {
    ...
    public Position<E> left(Position<E> v)
        ...
        if (leftPos == null) throw new BoundaryViolationException(
            "No left child"
        );
        return leftPos;
    }
    ...
    public Position<E> right(Position<E> v)
        ...
        if (rightPos == null) throw new BoundaryViolationException(
            "No right child"
        );
        return rightPos;
    }
    ...
    public Iterable<Position<E>> children(Position<E> v)
        ...
        if (hasLeft(v)) children.add(left(v));
        if (hasRight(v)) children.add(right(v));
        return children;
    }
    ...
    public Iterable<Position<E>> positions() {
        ...
        if (size != 0) inorderPositions(root(), positions); // assign positions in inorder
        return positions;
    }
    ...
    public Iterable<E> iterator() {
        ...
        for (Position<E> pos : positions) elements.add(pos.element());
    ...
    public Position<E> insertLeft(Position<E> v, E e)
        ...
        BTPosition<E> vv = checkPosition(v);
        Position<E> leftPos = vv.getLeft();
        if (leftPos != null) throw new InvalidPositionException(
    ...
    public Position<E> insertRight(Position<E> v, E e)
        ...
        BTPosition<E> vv = checkPosition(v);
        Position<E> rightPos = vv.getRight();
        if (rightPos != null) throw new InvalidPositionException(
    ...
    public void attach(Position<E> v, BinaryTree<E> T1, BinaryTree<E> T2)
        throws InvalidPositionException {
        BTPosition<E> vv = checkPosition(v);
        if (isInternal(v)) throw new InvalidPositionException(
    ...
    protected BTPosition<E> checkPosition(Position<E> v)
        throws InvalidPositionException {
        if (
            v == null || !(v instanceof BTPosition)
        ) throw new InvalidPositionException("The position is invalid");
        return (BTPosition<E>) v;
    }

    /** Creates a new binary tree node */
    protected BTPosition<E> createNode(
        E element,
        BTPosition<E> parent,
        BTPosition<E> left,
        BTPosition<E> right
    ...
    protected void inorderPositions(Position<E> v, ArrayList<Position<E>> pos)
        throws InvalidPositionException {
        checkPosition(v);
        if (hasLeft(v)) inorderPositions(left(v), pos); // recurse on left child
        pos.add(v);
        if (hasRight(v)) inorderPositions(right(v), pos); // recurse on right child
    }
    ...
    public int height2(Tree<E> T, Position<E> v) {
        ...
        int h = 0;
        for (Position<E> w : T.children(v)) h = Math.max(h, height2(T, w));
        return 1 + h;
    }
    ...
    public static void main(String[] args) {
        ...
        int n = 100;
        int j;
        if (T.isEmpty()) T.addRoot(rand.nextInt(1000));
