    ...
    implements CompleteBinaryTree<E>
{
    ...
    public Position<E> right(Position<E> v) throws InvalidPositionException {
        if (!hasRight(v)) throw new BoundaryViolationException(
            "No right child"
        );
        BTPos<E> vv = CheckPosition(v);
    ...
    public static void main(String[] args) {
        ArrayListCompleteBinaryTree<Integer> A =
            new ArrayListCompleteBinaryTree<Integer>();
        ...
        for (Integer in : A.iterator()) System.out.print(in + " ");
        System.out.println("\n");
    }
}
